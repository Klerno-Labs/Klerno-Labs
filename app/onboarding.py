...
class GuideStep(BaseModel):
    ...
    title: str
    content: str
    target_element: str | None = None  # CSS selector for element to highlight
...
class ContextualHelp:
    ...
    def get_quick_tip(self, user_experience_level: str = "beginner") -> dict[str, str]:
        ...
        actual_level = (
            ...
            if user_experience_level in tips_by_level
            else "beginner"
        )

        return {"tip": selected_tip, "level": actual_level, "category": "quick_tip"}
