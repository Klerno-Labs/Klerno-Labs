...
class AdvancedCache:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        avg_get_time = sum(self.get_times) / len(self.get_times) if self.get_times else 0
...
class PerformanceProfiler:
    ...
    def _init_performance_database(self) -> None:
        ...
        # Create indexes
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_perf_operation ON performance_metrics(operation)")
        ...
        try:
            ...
            for row in cursor.fetchall():
                operations.append({
                    ...
                    'error_count': row[6],
                    'error_rate_percent': round((row[6] / row[1]) * 100, 2) if row[1] > 0 else 0
                })
            ...
            system_summary = {
                ...
                'avg_available_memory_mb': round(system_row[4], 2) if system_row[4] else 0
            }
