...
class DashboardManager:
    ...
    def get_dashboard(self, dashboard_id: str, user_id: str = None) -> Optional[Dashboard]:
    ...
    def create_default_dashboard(self, user_id: str) -> Dashboard:
        ...
        self.add_widget(
            ...
            config={
                "map_type": "choropleth",
                "risk_metric": "average_risk_score"
            },
        ...
        self.add_widget(
            ...
            config={
                "status_indicators": ["aml", "kyc", "sanctions"]
            },
...
def get_dashboard(dashboard_id: str, user_id: str = None) -> Optional[Dashboard]:
