...
class AdvancedSecurityOrchestrator:
    ...
    async def initialize_security_systems(self) -> None:
        ...
        try:
            ...
            await self.security_orchestrator.threat_intelligence.update_threat_feeds()
    ...
    async def update_threat_intelligence(self) -> List[Dict[str, Any]]:
        """Update threat intelligence feeds."""
        return await self.security_orchestrator.threat_intelligence.update_threat_feeds()
