    ...
    def check_alerts(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for alert in self.alerts.values():
                ...
                condition_met = False
                if alert.operator == "gt" and avg_value > alert.threshold:
                    condition_met = True
                elif alert.operator == "lt" and avg_value < alert.threshold:
                    condition_met = True
                elif alert.operator == "eq" and abs(avg_value - alert.threshold) < 0.01:
                    condition_met = True
                ...
                if condition_met and not alert.active:
                    ...
                    logger.warning(f"🚨 Alert triggered: {alert.name} - {avg_value:.2f}")
                    ...
                    logger.info(f"✅ Alert resolved: {alert.name} after {duration:.1f}s")
