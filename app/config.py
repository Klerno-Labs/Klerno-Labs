...
class Settings(BaseSettings):
    ...
    # App configuration
    APP_ENV: str=Field("dev", description="Application environment: 'dev', 'test', 'production', or 'development'")
    ...
    def validate_app_env(cls, v: str) -> str:
        ...
        if v.lower() not in {"dev", "test", "production", "development", "local"}:
            raise ValueError("APP_ENV must be 'dev', 'test', 'production', 'development', or 'local'")
        return v.lower()
