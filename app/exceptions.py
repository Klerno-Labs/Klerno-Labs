...
async def klerno_exception_handler(request: Request, exc: KlernoException) -> JSONResponse:
...
async def http_exception_handler(request: Request, exc: HTTPException) -> JSONResponse:
    ...
    if exc.status_code in [401, 403]:
        log_security_event(
            event_type="authentication_failure" if exc.status_code == 401 else "authorization_failure",
