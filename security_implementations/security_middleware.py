...
Reference-only:
- This module is generated by `security_hardening_implementation.py` and kept
    as a template. The production app in `app/main.py` already sets security
    headers and CSP through its own middleware, so this file is not imported to
    prevent duplication.
"""
